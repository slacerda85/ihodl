...
const OpenChannelModal: React.FC<OpenChannelModalProps> = ({ visible, onClose, onOpenChannel }) => {
            ...
            <View style={styles.formRow}>
              ...
              <View style={[styles.formGroup, styles.formHalf]}>
                ...
                <TextInput
                  ...
                  keyboardType="numeric"
                />
                {errors.remoteCsvDelay && (
                  <Text style={styles.errorText}>{errors.remoteCsvDelay}</Text>
                )}
              </View>
            </View>
